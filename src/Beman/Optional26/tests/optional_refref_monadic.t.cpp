...
constexpr beman::optional26::optional<const int&&> get_opt_int(int) { return std::move(constexpr_fortytwo); }
} // namespace

TEST(OptionalRefRefMonadicTest, Transform) {
    // lhs is empty
    ...
    // lhs has value
    int                                forty = 40;
    beman::optional26::optional<int&&> o2    = std::move(forty);
    ...
    int                                fortytwo = 42;
    beman::optional26::optional<int&&> o3       = std::move(fortytwo);
    ...
    forty                                        = 40;
    const beman::optional26::optional<int&&> o5  = std::move(forty);
    auto                                     o5r = o5.transform([](int&& i) { return i + 2; });
    static_assert((std::is_same<decltype(o5r), beman::optional26::optional<int>>::value));
    EXPECT_TRUE(o5r.value() == 42);

    // test each overload in turn
    fortytwo                               = 42;
    beman::optional26::optional<int&&> o8  = std::move(fortytwo);
    auto                               o8r = o8.transform([](int) { return 42; });
    EXPECT_TRUE(*o8r == 42);

    beman::optional26::optional<int&&> o12  = std::move(fortytwo);
    auto                               o12r = std::move(o12).transform([](int) { return 42; });
    EXPECT_TRUE(*o12r == 42);

    const beman::optional26::optional<int&&> o16  = std::move(fortytwo);
    auto                                     o16r = o16.transform([](int) { return 42; });
    EXPECT_TRUE(*o16r == 42);

    const beman::optional26::optional<int&&> o20  = std::move(fortytwo);
...
TEST(OptionalRefRefMonadicTest, TransformConstexpr) {

    // test each overload in turn
    constexpr beman::optional26::optional<const int&&> o16  = std::move(constexpr_fortytwo);
    constexpr auto                                     o16r = o16.transform(get_int);
    static_assert(*o16r == 42);

    constexpr beman::optional26::optional<const int&&> o20  = std::move(constexpr_fortytwo);
...
TEST(OptionalRefRefMonadicTest, Transform2) {
    // lhs is empty
    beman::optional26::optional<int&&> o1;
    auto                               o1r = o1.transform([](int i) { return i + 2; });
    static_assert((std::is_same<decltype(o1r), beman::optional26::optional<int>>::value));
...
TEST(OptionalRefRefMonadicTest, TransformConstxpr) {
    // test each overload in turn
    constexpr beman::optional26::optional<const int&&> o16  = std::move(constexpr_fortytwo);
    constexpr auto                                     o16r = o16.transform(get_int);
    static_assert(*o16r == 42);
...
TEST(OptionalRefRefMonadicTest, and_then) {
    // lhs is empty
    beman::optional26::optional<int&&> o1;
    ...
    // rhs returns empty
    beman::optional26::optional<int&&> o4  = std::move(twelve);
    ...
    // ensure that function object is forwarded
    int                                fortytwo = 42;
    beman::optional26::optional<int&&> o5       = std::move(fortytwo);
    ...
    const beman::optional26::optional<int&&> o7 = std::move(fortytwo);
    ...
    beman::optional26::optional<int&&> o9 = std::move(fortytwo);
    auto o9r = std::move(o9).and_then([](int) { return beman::optional26::make_optional(42); });
    EXPECT_TRUE(*o9r == 42);

    const beman::optional26::optional<int&&> o10 = std::move(fortytwo);
    auto o10r = o10.and_then([](int) { return beman::optional26::make_optional(42); });
    EXPECT_TRUE(*o10r == 42);

    const beman::optional26::optional<int&&> o11 = std::move(fortytwo);
    ...
    int                                i = 3;
    beman::optional26::optional<int&&> o20{std::move(i)};
    std::move(o20).and_then([](int&& r) { return beman::optional26::optional<int&&>{std::move(++r)}; });
    EXPECT_TRUE(o20);
    EXPECT_TRUE(i == 4);
}

TEST(OptionalRefRefMonadicTest, Constexpr_and_then) {
    constexpr beman::optional26::optional<const int&&> o10  = std::move(constexpr_fortytwo);
    constexpr auto                                     o10r = o10.and_then(get_opt_int);
    EXPECT_TRUE(*o10r == 42);

    constexpr beman::optional26::optional<const int&&> o11  = std::move(constexpr_fortytwo);
...
TEST(OptionalRefRefMonadicTest, or_else) {
    int                                fortytwo = 42;
    int                                thirteen = 13;
    beman::optional26::optional<int&&> o1       = std::move(fortytwo);
    EXPECT_TRUE(*(o1.or_else([&] { return beman::optional26::optional<int&&>(std::move(thirteen)); })) == 42);

    beman::optional26::optional<int&&> o2;
    EXPECT_EQ(*(o2.or_else([&] { return beman::optional26::optional<int&&>(std::move(thirteen)); })), 13);
}
