...
constexpr beman::optional::optional<const int&> get_opt_int(int) { return constexpr_fortytwo; }
} // namespace
...
TEST(OptionalRefMonadicTest, Transform) {
    ...
    // lhs has value
    int                           forty = 40;
    beman::optional::optional<int&> o2    = forty;
    ...
    int                           fortytwo = 42;
    beman::optional::optional<int&> o3       = fortytwo;
    ...
    // forty = 40;
    // beman::optional::optional<int&> o4 = forty;
    ...
    forty                                   = 40;
    const beman::optional::optional<int&> o5  = forty;
    ...
    fortytwo                          = 42;
    beman::optional::optional<int&> o8  = fortytwo;
    auto                          o8r = o8.transform([](int) { return 42; });
    EXPECT_TRUE(*o8r == 42);

    beman::optional::optional<int&> o12  = fortytwo;
    auto                          o12r = std::move(o12).transform([](int) { return 42; });
    EXPECT_TRUE(*o12r == 42);

    const beman::optional::optional<int&> o16  = fortytwo;
    auto                                o16r = o16.transform([](int) { return 42; });
    EXPECT_TRUE(*o16r == 42);

    const beman::optional::optional<int&> o20  = fortytwo;
    ...
    beman::optional::optional<int&> o38  = fortytwo;
...
TEST(OptionalRefMonadicTest, TransformConstexpr) {
    ...
    // test each overload in turn
    constexpr beman::optional::optional<const int&> o16  = constexpr_fortytwo;
    constexpr auto                                o16r = o16.transform(get_int);
    static_assert(*o16r == 42);

    constexpr beman::optional::optional<const int&> o20  = constexpr_fortytwo;
...
TEST(OptionalRefMonadicTest, TransformConstxpr) {
    ...
    constexpr beman::optional::optional<const int&> o32  = beman::optional::nullopt;
    constexpr auto                                o32r = o32.transform(get_int);
    static_assert(!o32r);
    constexpr beman::optional::optional<int&> o36  = beman::optional::nullopt;
    constexpr auto                          o36r = std::move(o36).transform(get_int);
...
TEST(OptionalRefMonadicTest, and_then) {
    ...
    // rhs returns empty
    beman::optional::optional<int&> o4  = twelve;
    ...
    // ensure that function object is forwarded
    int                           fortytwo = 42;
    beman::optional::optional<int&> o5       = fortytwo;
    auto                          o5r      = o5.and_then(rval_call_and_then{});
    static_assert((std::is_same<decltype(o5r), beman::optional::optional<double>>::value));
    EXPECT_TRUE(o5r.value() == 42);

    // // ensure that lhs is forwarded
    // beman::optional::optional<int&> o6 = fortytwo;
    // auto o6r =
    //     std::move(o6).and_then([](int &&i) { return beman::optional::optional<double>(i); });
    ...
    const beman::optional::optional<int&> o7 = fortytwo;
...
TEST(OptionalRefMonadicTest, Constexpr_and_then) {
    constexpr beman::optional::optional<const int&> o10  = constexpr_fortytwo;
    constexpr auto                                o10r = o10.and_then(get_opt_int);
    EXPECT_TRUE(*o10r == 42);

    constexpr beman::optional::optional<const int&> o11  = constexpr_fortytwo;
...
TEST(OptionalRefMonadicTest, or_else) {
    ...
    EXPECT_TRUE(*(o1.or_else([&] { return beman::optional::optional<int&>(thirteen); })) == 42);

    beman::optional::optional<int&> o2;
    EXPECT_EQ(*(o2.or_else([&] { return beman::optional::optional<int&>(thirteen); })), 13);
}
