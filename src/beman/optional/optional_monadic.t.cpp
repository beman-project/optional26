...
TEST(OptionalMonadicTest, and_then)
 {
    ...
    struct rval_call_and_then {
      beman::optional::optional<double> operator()(int) && {
        return beman::optional::optional<double>(42.0);
      };
    };
    ...
    auto o7r =
        o7.and_then([](const int &i) { return beman::optional::optional<double>(i); });
    ...
    auto o9r =
        std::move(o9).and_then([](int) { return beman::optional::make_optional(42); });
    EXPECT_TRUE(*o9r == 42);
    ...
    auto o11r =
        std::move(o11).and_then([](int) { return beman::optional::make_optional(42); });
    EXPECT_TRUE(*o11r == 42);
    ...
    auto o17r =
        std::move(o17).and_then([](int) { return beman::optional::make_optional(42); });
    EXPECT_TRUE(!o17r);
